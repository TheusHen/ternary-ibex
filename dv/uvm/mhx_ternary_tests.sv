...
class mhx_ternary_base_test extends uvm_test;
  ...
  virtual function void report_phase(uvm_phase phase);
    ...
    if (env.agent.monitor.errors_detected == 0) begin
      ...
      `uvm_error(
        "TEST_RESULT",
        $sformatf("Status: FAILED (%0d errors detected)", env.agent.monitor.errors_detected)
      );
    end
...
class mhx_ternary_basic_test extends mhx_ternary_base_test;
  ...
  virtual task run_default_sequence();
    mhx_ternary_operations_sequence ternary_seq =
        mhx_ternary_operations_sequence::type_id::create("ternary_seq");
    mhx_ternary_neural_sequence neural_seq =
        mhx_ternary_neural_sequence::type_id::create("neural_seq");
...
class mhx_ternary_random_test extends mhx_ternary_base_test;
  ...
  virtual task run_default_sequence();
    mhx_ternary_random_sequence seq =
        mhx_ternary_random_sequence::type_id::create("random_seq");
...
class mhx_ternary_corner_test extends mhx_ternary_base_test;
  ...
  virtual task run_default_sequence();
    mhx_ternary_corner_sequence seq =
        mhx_ternary_corner_sequence::type_id::create("corner_seq");
...
class mhx_ternary_coverage_test extends mhx_ternary_base_test;
  ...
  virtual task run_default_sequence();
    mhx_ternary_coverage_sequence seq =
        mhx_ternary_coverage_sequence::type_id::create("coverage_seq");
...
class mhx_ternary_stress_test extends mhx_ternary_base_test;
  ...
  virtual task run_default_sequence();
    mhx_ternary_stress_sequence seq =
        mhx_ternary_stress_sequence::type_id::create("stress_seq");
...
class mhx_ternary_error_test extends mhx_ternary_base_test;
  ...
  virtual task run_default_sequence();
    mhx_ternary_random_sequence seq =
        mhx_ternary_random_sequence::type_id::create("error_seq");
  ...
  virtual function void report_phase(uvm_phase phase);
    ...
    `uvm_info(
      "TEST_RESULT",
      $sformatf(
        "Errors detected: %0d (expected due to error injection)",
...
class mhx_ternary_performance_test extends mhx_ternary_base_test;
  ...
  virtual task run_default_sequence();
    mhx_ternary_random_sequence seq =
        mhx_ternary_random_sequence::type_id::create("perf_seq");
  ...
  virtual function void report_phase(uvm_phase phase);
    ...
    `uvm_info(
      "PERF_RESULT",
      $sformatf(
        "Average latency: %0.1f cycles",
        env.agent.monitor.average_latency
      ),
      UVM_LOW
    );
    `uvm_info(
...
class mhx_ternary_regression_test extends mhx_ternary_base_test;
  ...
  virtual task run_default_sequence();
    ...
    fork
      // Basic operations
      begin
        mhx_ternary_operations_sequence ops_seq =
            mhx_ternary_operations_sequence::type_id::create("ops_seq");
      ...
      // Corner cases
      begin
        mhx_ternary_corner_sequence corner_seq =
            mhx_ternary_corner_sequence::type_id::create("corner_seq");
      ...
      // Random transactions
      begin
        mhx_ternary_random_sequence random_seq =
            mhx_ternary_random_sequence::type_id::create("random_seq");
