...
int main(int argc, char **argv) {
  ...
  // Construct the Verilated model, from Vmhx_ternary_test.h generated from
  // Verilating "mhx_ternary_test.sv"
  std::unique_ptr<Vmhx_ternary_test> top{
      new Vmhx_ternary_test{contextp.get(), "TOP"}};
  ...
  std::cout << "Simulation completed after " << main_time << " time units."
            << std::endl;
