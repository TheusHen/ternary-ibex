...
module ibex_core import ibex_pkg::*; #(
  ...
  parameter ibex_pkg::pmp_cfg_t     PMPRstCfg[16]    = '{default: '{lock: 1'b0, mode: ibex_pkg::PMP_MODE_OFF, exec: 1'b0, write: 1'b0, read: 1'b0}},
  parameter logic [33:0]            PMPRstAddr[16]   = '{default: 34'h0},
  parameter ibex_pkg::pmp_mseccfg_t PMPRstMsecCfg    = '{rlb: 1'b0, mmwp: 1'b0, mml: 1'b0},
...
`ifdef RVFI
  ...
  ibex_id_stage #(
    ...
    .neural_op_id_o       (neural_op_id),
    .ternary_raddr_a_id_o (ternary_raddr_a_id),
    .ternary_raddr_b_id_o (ternary_raddr_b_id),
    .ternary_waddr_id_o   (ternary_waddr_id),
    .ternary_we_id_o      (/* unused */)
  );
  ...
  ibex_ternary_alu ternary_alu_i (
    ...
    .overflow_o       (ternary_alu_overflow),
    .trit_overflow_o  (ternary_alu_trit_overflow)
  );
  ...
  `ASSERT_IF(TernaryAluOverflowConsistency,
